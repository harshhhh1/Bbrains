...
router.get('/recorded-transactions', verifyToken, checkPermission('manage_finance'), getRecordedTransactions);
router.post('/manual-transaction', verifyToken, checkPermission('manage_finance'), createManualTransaction);
router.get('/transactions/user/:userId', verifyToken, checkPermission('manage_finance'), getUserTransactionsList);
