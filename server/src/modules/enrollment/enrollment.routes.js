...
import { enroll, enrollBulkUsers, getEnrollments, getCourseEnrollmentsList, unenroll, updateGrade } from './enrollment.controller.js';
...
router.post('/bulk', verifyToken, enrollBulkUsers);
