...
import type { SavingState } from "../types/settings";
import { FieldBlock, MetricCard, PinSlots, SectionCard } from "./settings-ui";

type SettingsWalletTabProps = {
  saving: SavingState;
  isPinSet: boolean;
  oldPin: string;
  newPin: string;
      ...
      >
        <div className="space-y-4">
          <div className="rounded-[1.25rem] bg-primary/10 p-5">
            ...
            <p className="mt-3 text-3xl font-bold tracking-tight text-foreground">{formatCurrency(walletBalance)}</p>
          </div>
