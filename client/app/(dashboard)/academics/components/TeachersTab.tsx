...
import { TeachersTable } from "@/app/(dashboard)/admin/teachers/_components/TeachersTable"
import { TeacherForm } from "@/app/(dashboard)/admin/teachers/_components/TeacherForm"
import { fetchTeachers } from "@/app/(dashboard)/admin/teachers/data"
import { initForm, emptyTeacherForm, type TeacherForm as TeacherFormType } from "@/app/(dashboard)/admin/teachers/_types"
...
export function TeachersTab({ initialTeachers, loading: externalLoading, onRefresh, createOpen, onCreateOpenChange }: TeachersTabProps) {
    ...
    async function handleSubmit() {
        ...
        try {
            ...
            if (editing) {
                ...
                const r = await api.post<ApiUser>("/user/teachers", { ...payload, password: "TemporaryPassword123!" })
                if (r.success) {
