                      ...
                      <div className="space-y-2">
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <button
                            ...
                            className="group flex items-center gap-1.5 rounded-md bg-muted/50 px-2 py-0.5 text-[10px] font-mono text-muted-foreground hover:bg-muted hover:text-foreground transition-colors"
