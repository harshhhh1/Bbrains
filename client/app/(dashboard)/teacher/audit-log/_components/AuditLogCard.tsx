      ...
      <CardContent className="p-5">
        <div className="flex flex-col gap-4">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div className="space-y-0.5">
                ...
                <Badge className={cn("text-[9px] font-black uppercase tracking-widest px-2 py-0 border", categoryColors[log.category])}>
                  {log.category}
                </Badge>
              </div>
            </div>
          ...
          <div className="flex items-center gap-2 text-sm">
            <span className="font-black text-foreground uppercase tracking-tight text-xs">{log.action}</span>
            <span className="text-[10px] font-bold text-muted-foreground uppercase opacity-40 tracking-widest">on</span>
            <span className="font-bold text-foreground/80">{log.entity}</span>
            {log.entityId && (
              <>
                <span className="text-muted-foreground/30">#</span>
                <span className="text-muted-foreground font-mono text-[10px] bg-muted px-1.5 py-0.5 rounded border border-border/50">{log.entityId}</span>
              </>
            )}
          </div>
          ...
          {change && (
            <div className="grid grid-cols-1 sm:grid-cols-[1fr_auto_1fr] items-center gap-3 text-[11px] bg-muted/30 rounded-2xl p-4 border border-border/40">
              <div className="min-w-0">
                <p className="text-[9px] font-black uppercase text-muted-foreground/50 tracking-widest mb-1.5 ml-1">Previous State</p>
              ...
              <div className="min-w-0">
                <p className="text-[9px] font-black uppercase text-primary/50 tracking-widest mb-1.5 ml-1">New State</p>
