...
const gamificationFeatures = [
  {
    ...
    content: "Earn Experience Points from every academic activity. Complete assignments, attend classes, and maintain streaks to climb the leaderboard.",
    cardStyle: "bg-white rotate-1",
    cardDecoration: "tape" as const,
  ...
  },
  {
    ...
    content: "Convert your academic achievements into B-Coins. Track your balance, send money to friends, and manage your campus finances.",
    cardStyle: "rotate-1",
  ...
  },
  {
    ...
    content: "Campus-wide and class-specific rankings. See where you stand, compete with classmates, and earn bragging rights.",
    cardStyle: "bg-white -rotate-1",
    cardDecoration: "tape" as const,
    cardVariant: "default" as const,
  },
  {
    ...
    content: "Collect badges for reaching milestones. First login, 7-day streak, top of the class - celebrate every accomplishment.",
    cardStyle: "rotate-1",
    cardDecoration: "tack" as const,
    cardVariant: "default" as const,
  },
  {
    ...
    content: "Use your B-Coins in the marketplace. Unlock premium parking, dining credits, merchandise, and digital products.",
    cardStyle: "bg-white -rotate-1",
    cardDecoration: "tape" as const,
    cardVariant: "default" as const,
  },
    ...
    <section className="py-20 px-6 max-w-6xl mx-auto relative z-10">
      <div className="text-center mb-12">
        ...
        <p className="font-patrick text-lg text-hand-pencil/70 mt-4 max-w-2xl mx-auto">
          Our gamification system keeps students engaged and motivated throughout their academic journey.
        </p>
      </div>
        ...
        {gamificationFeatures.map((feature, idx) => {
          ...
          return (
            ...
            >
              ...
              <HandCardContent>
                <p className="font-patrick text-base text-hand-pencil/80">{feature.content}</p>
              </HandCardContent>
            </HandCard>
          );
        })}
