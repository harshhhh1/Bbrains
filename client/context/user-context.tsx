...
export function UserProvider({ children }: { children: React.ReactNode }) {
    ...
    const refreshUser = useCallback(async () => {
        ...
        const formattedUser = {
            ...
            displayName: details?.displayName || dbUser.displayName || "",
            fullName: (details?.displayName || dbUser.displayName) || (details?.firstName || dbUser.firstName ? `${details?.firstName || dbUser.firstName} ${details?.lastName || dbUser.lastName || ""}`.trim() : (dbUser?.username || "User")),
