...
export function HeroSection() {
  const { title, subtitle, primaryCta, secondaryCta, floatingCard } =
    landingData.hero;
    ...
    <section className="pt-24 pb-20 px-6 max-w-6xl mx-auto relative">
      <div className="absolute top-20 left-10 md:left-0 hidden lg:block pointer-events-none">
        <svg
          ...
          className="text-hand-yellow opacity-80 animate-bounce"
          style={{ animationDuration: "3s" }}
        >
          <path
            d="M60 10C87.6142 10 110 32.3858 110 60C110 87.6142 87.6142 110 60 110C32.3858 110 10 87.6142 10 60C10 32.3858 32.3858 10 60 10Z"
            stroke="currentColor"
            strokeWidth="4"
            strokeLinecap="round"
        ...
        <div className="space-y-8 z-10 relative">
          <div>
            ...
            <h1 className="font-kalam text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.1] text-hand-pencil">
              {title.part1} <br />
              {title.part2}{" "}
              <span className="text-hand-red relative inline-block group cursor-default">
                {title.highlight}
        ...
        <div className="relative">
          <div className="relative z-10 p-4 -rotate-2 hover:rotate-0 transition-all duration-300">
            <HandCard
              variant="yellow"
              decoration="tack"
              className="p-2 sm:p-4 aspect-square max-w-[420px] mx-auto flex items-center justify-center bg-white"
            >
              <div className="w-full h-full rounded-wobblyMd border-2 border-hand-pencil/40 border-dashed flex flex-col items-center justify-center p-8 text-center gap-4 group">
                <Sparkles
                  className="w-16 h-16 text-hand-blue group-hover:scale-110 transition-transform"
                  strokeWidth={2}
                />
                <h2 className="font-kalam text-3xl font-bold">
                  {floatingCard.title}
                </h2>
                ...
                <HandButton
                  ...
                  className="mt-4"
                  onClick={() =>
                    toast.success(`${floatingCard.subtitle}`, {
