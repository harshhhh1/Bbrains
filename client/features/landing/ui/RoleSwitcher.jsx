    ...
    <section id="features" className="py-24 px-6 bg-hand-cream/50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <span className="font-kalam text-hand-red text-lg">
            Explore Features
          </span>
          ...
          <p className="font-patrick text-xl text-hand-pencil/70 mt-4 max-w-2xl mx-auto">
            Click on a role to explore the features designed specifically for
            them.
          </p>
        </div>
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isComingSoon &&
                      "opacity-75 hover:opacity-100 border-dashed animate-pulse",
                  )}
                  style={isComingSoon ? { animationDuration: "4s" } : undefined}
                >
                  <div className="flex items-start gap-4">
                    <div className={cn("p-3 rounded-wobbly", feature.iconBg)}>
                  ...
                  <div className="mt-4 pt-4 border-t border-hand-pencil/10">
                    <ul className="space-y-2">
                      {feature.details.map((detail, idx) => (
                        <li
                          key={idx}
                          className="flex items-start gap-2 font-patrick text-sm text-hand-pencil/80"
                        >
                          <span className="text-hand-blue mt-1">•</span>
                          <span>
                            <strong className="text-hand-pencil">
                              {detail.title}:
                            </strong>{" "}
                            {detail.description}
                          </span>
