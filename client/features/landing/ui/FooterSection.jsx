        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div className="space-y-4 col-span-1">
            <div className="flex items-center gap-2 group">
              <Brain
                className="w-6 h-6 text-hand-red group-hover:-rotate-12 transition-transform"
                strokeWidth={2.5}
              />
              <span className="font-kalam text-2xl font-bold tracking-tight text-hand-pencil">
                {brand.name}
              </span>
            </div>
              ...
              <ul className="space-y-4 font-patrick text-lg text-hand-pencil/80">
                {section.links.map((link, linkIdx) => (
                  <li key={linkIdx}>
                    <Link
                      href={link.url}
                      className="hover:text-hand-blue hover:underline decoration-1 underline-offset-2"
                    >
                      {link.text}
                    </Link>
                  </li>
