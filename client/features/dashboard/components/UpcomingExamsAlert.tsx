...
import { AlertTriangle, CalendarDays, BookOpen, ChevronRight } from "lucide-react";
...
export function UpcomingExamsAlert() {
  const [upcomingExams, setUpcomingExams] = useState<ApiExam[]>([]);
    ...
    async function loadExams() {
      try {
        ...
        if (res.success && res.data) {
          const allExams: ApiExam[] = Array.isArray(res.data) ? res.data : [];
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="font-black text-foreground truncate">{exam.topic}</p>
