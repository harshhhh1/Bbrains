...
const LeaderboardCard = dynamic(
  () =>
    import("@/features/dashboard/ui/LeaderboardCard").then(
      (mod) => mod.LeaderboardCard,
    ),
  {
...
const MyTasksCard = dynamic(
  () =>
    import("@/features/dashboard/ui/MyTasksCard").then(
      (mod) => mod.MyTasksCard,
    ),
  {
    loading: () => <Skeleton className="h-[400px] w-full rounded-2xl" />,
...
const AnnouncementsCard = dynamic(
  () =>
    import("@/features/dashboard/ui/AnnouncementsCard").then(
      (mod) => mod.AnnouncementsCard,
    ),
  {
...
const UpcomingEventsCard = dynamic(
  () =>
    import("@/features/dashboard/ui/UpcomingEventsCard").then(
      (mod) => mod.UpcomingEventsCard,
    ),
  {
    loading: () => <Skeleton className="h-[300px] w-full rounded-2xl" />,
    ssr: true,
...
export function StudentDashboard({
  ...
  const initialMyPosition = dashboardData?.stats?.leaderboardRank
    ? {
        ...
        points:
          typeof dashboardData?.wallet?.balance === "number"
