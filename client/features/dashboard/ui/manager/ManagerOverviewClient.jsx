...
export function ManagerOverviewClient({ stats }) {
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="max-w-3xl text-sm text-muted-foreground">
                This dashboard reuses the current system data. Where the project
                has no salary or staff-attendance records yet, the card states
                that clearly instead of inventing numbers.
              </p>
            </div>
          </div>
              ...
              <Card className="border-border/60 bg-background/80 shadow-sm backdrop-blur transition-all hover:border-primary/40 hover:shadow-md">
                <CardContent className="p-4">
                  ...
                  <p className="mt-2 text-2xl font-bold text-foreground">
                    {formatCurrency(
                      stats.manager.ownIncomeReceived,
      ...
      <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <Card className="border-border/60 shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              Boys and girls counts are taken from the existing student records.
              Unspecified entries stay separate.
            </CardDescription>
          </CardHeader>
              ...
              <div className="flex items-center justify-between gap-3">
                <div>
                  <p className="text-sm font-semibold text-foreground">
                    Classes tracked in the institution
                  </p>
                  <p className="text-sm text-muted-foreground">
                    The current project stores these as courses, so that count
                    is reused for the manager view.
                  </p>
                </div>
        ...
        <Card className="border-border/60 shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              Fees received are pulled from the existing fee configs or
              fee-tagged transactions. Salary paid is shown only when
              salary-like data exists.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_1fr]">
        <Card className="border-border/60 shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              This is based only on attendance records that already exist for
              users marked as teacher or staff.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
              ...
              <>
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="rounded-2xl bg-muted/40 p-4">
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      {stats.attendance.teacherRecords} teacher records and{" "}
                      {stats.attendance.staffRecords} staff records
                    </p>
                  </div>
                  <div className="rounded-2xl bg-primary/10 p-4">
                    ...
                    <p className="mt-2 text-2xl font-bold text-foreground">
                      {formatDate(stats.attendance.latestMarkedAt)}
                    </p>
                  </div>
                </div>
        ...
        <Card className="border-border/60 shadow-sm">
          ...
          <CardContent className="space-y-5">
            ...
            <div>
              ...
              <InfoRow
                label="Phone"
                value={stats.manager.phone || "Non existent"}
              />
              <InfoRow
                label="Wallet Balance"
                value={formatCurrency(
                  stats.manager.walletBalance,
                  stats.finance.currency,
                )}
              />
              <InfoRow
                label="Joined"
                value={formatDate(stats.manager.createdAt)}
              />
              <InfoRow
                label="Bio"
                value={stats.manager.bio || "Non existent"}
              />
            </div>
          </CardContent>
        </Card>
        ...
        <CardHeader>
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <CardDescription>
                The manager dashboard reuses the same institution profile
              ...
              <div className="rounded-2xl border border-border/60 p-4 lg:col-span-2">
                <div className="grid gap-4 md:grid-cols-3">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-base font-semibold text-foreground">
                      {stats.institution.address || "Non existent"}
                    </p>
                  </div>
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-[0.14em] text-muted-foreground">
