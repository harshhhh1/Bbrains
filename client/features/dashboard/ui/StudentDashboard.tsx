...
const LeaderboardCard = dynamic(() => import("@/features/dashboard/ui/LeaderboardCard").then(mod => mod.LeaderboardCard), {
  loading: () => <Skeleton className="h-[400px] w-full rounded-2xl" />,
  ssr: true
});

const MyTasksCard = dynamic(() => import("@/features/dashboard/ui/MyTasksCard").then(mod => mod.MyTasksCard), {
  loading: () => <Skeleton className="h-[400px] w-full rounded-2xl" />,
  ssr: true
});

const AnnouncementsCard = dynamic(() => import("@/features/dashboard/ui/AnnouncementsCard").then(mod => mod.AnnouncementsCard), {
  loading: () => <Skeleton className="h-[300px] w-full rounded-2xl" />,
  ssr: true
});

const UpcomingEventsCard = dynamic(() => import("@/features/dashboard/ui/UpcomingEventsCard").then(mod => mod.UpcomingEventsCard), {
  loading: () => <Skeleton className="h-[300px] w-full rounded-2xl" />,
  ssr: true
});
