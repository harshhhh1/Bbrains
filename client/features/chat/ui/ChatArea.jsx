    ...
    <div className="flex-1 flex flex-col bg-white dark:bg-gray-900 relative">
      ...
      <div className="flex-1 overflow-y-auto p-6 pt-20 space-y-6">
        ...
        <div className="flex items-center justify-center relative">
          ...
          <span className="relative bg-white dark:bg-gray-900 px-4 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
            Yesterday
          </span>
        </div>
        ...
        <div className="group flex gap-4 hover:bg-gray-50 dark:hover:bg-gray-800/50 p-2 -mx-2 rounded-xl transition-colors relative">
          <Image
            ...
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuCzos9RzH54rNyLiSgreh6VR62qQCcPhCteRzY3BM7URRbNdIcuxUrFIqHltlKaNTPnZUSyYawK35uGfN832b-Yft32xicBjVQJ_eASs3TpfyInSRgNOxyk_o4PcfGQuZj5OnfYMk75Wu7sdXGbUGUbgFVzbtMxUoA5O4RYcSLVZ7qCj8ZfD8Jmjt08DKmvRKhBDFZI_BvqjNpdvRRa4Tcjtge_j4x0t-rERZd5HYWURLe1lvAbtPFbZMtS22ltLa81H1ANhI2iQwMV"
          />
          <div className="flex-1">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-sm">
              Hey everyone! Has anyone started on the new computer science
              assignment yet? I&apos;m finding the second part a bit tricky.
            </p>
          </div>
          {/* Hover Actions */}
          <div className="absolute top-0 right-4 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm rounded-lg flex items-center divide-x divide-gray-200 dark:divide-gray-700">
            <button
              className="p-1.5 text-gray-500 hover:text-indigo-600 dark:hover:text-white"
              title="Reply"
            >
        ...
        <div className="group flex gap-4 hover:bg-gray-50 dark:hover:bg-gray-800/50 p-2 -mx-2 rounded-xl transition-colors relative">
          <Image
            ...
            height={40}
            className="w-10 h-10 rounded-full mt-1 object-cover"
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuAe7bpcUcCjr9t88LPidJvh29WW9JJS8XvxdI-4XfZ7yzPoyqnVBhNbJk4y0r5-a7Qxw_AQYiR2ubdNwOxAmB2JLmkhIbXgv9knQ5_h5VN7Nkn6vG9z0Z3d4Bwifgx47lIO86Dj-iaOJ6bTzFcU3uRraKfLfNKQhzuy0OoAXdj3g3FyNKPQQTIYZ3s81nlHoOEX9SjK27kolM2VMvhygvDjcKjVESpkZ6no4i6lRtXfyE9KVGN4GR9jdFZBuv3ZgV85ojXHnaJvXFPG"
          />
          <div className="flex-1">
            <div className="flex items-baseline gap-2 mb-1">
              <span className="font-semibold text-gray-900 dark:text-white">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-sm">
              Yeah, I looked at it. For the second part, try reviewing the
              lecture notes from last Tuesday. It covers the specific algorithm
              needed.
            </p>
          </div>
          {/* Hover Actions */}
        ...
        <div className="group flex gap-4 bg-yellow-50 dark:bg-yellow-900/10 hover:bg-yellow-100 dark:hover:bg-yellow-900/20 p-2 -mx-2 rounded-xl transition-colors relative border-l-4 border-yellow-400">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-sm">
              Thanks Alex!{" "}
              <span className="bg-yellow-200 dark:bg-yellow-800/50 text-yellow-800 dark:text-yellow-200 px-1 py-0.5 rounded font-medium">
                @Alex Johnson
              </span>{" "}
              That helped a lot. Also, does anyone know what time the library
              closes tonight?
            </p>
          </div>
          {/* Hover Actions */}
        ...
        <div className="group flex gap-4 hover:bg-gray-50 dark:hover:bg-gray-800/50 p-2 -mx-2 rounded-xl transition-colors relative">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-sm">
              Just a reminder that the deadline for the physics project is
              extended to Friday. Please check the announcements page for
              details.
            </p>
          </div>
        </div>
