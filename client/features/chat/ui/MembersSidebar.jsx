  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div
          className={`absolute bottom-0 right-0 w-2.5 h-2.5 ${statusColor} border-2 border-white dark:border-gray-800 rounded-full`}
        ></div>
      </div>
            ...
            className={`font-medium text-sm truncate
                        ${
                          member.role === "admin"
                            ...
                            : member.badge?.toLowerCase() === "teacher"
...
export const Memberssidebar = React.memo(function MembersSidebar({
  members,
  onClose,
  onOpenProfile,
  currentUserId,
