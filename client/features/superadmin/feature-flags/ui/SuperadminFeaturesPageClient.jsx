...
const GLOBAL_FEATURES = [
  {
    ...
    description:
      "Put the entire system into maintenance mode. All user access will be temporarily disabled.",
  },
  {
    key: "global_announcements",
    label: "Global Announcements",
    description: "Enable or disable global announcements across all colleges.",
  },
  {
    key: "beta_features",
    label: "Beta Features",
    description: "Opt-in to system-wide experimental features.",
  },
];
  ...
  return (
    <div className="max-w-3xl space-y-6">
      ...
      <p className="text-muted-foreground">
        Manage system-wide feature flags that affect all colleges.
      </p>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Global variables and master feature flags.
          </CardDescription>
        </CardHeader>
