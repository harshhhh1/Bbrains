...
export function CollegeAdminsCard({ collegeId, admins, onUpdate }) {
      ...
      <Card className="border-border/60 shadow-sm">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <div className="space-y-1">
            ...
            <CardDescription>
              Primary contacts managing this college
            </CardDescription>
          </div>
          <Button
        ...
        <CardContent className="pt-4">
          ...
          {admins.length === 0 ? (
            <p className="text-sm text-muted-foreground italic">
              No administrators found for this college.
            </p>
          ) : (
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium">
                        {admin.userDetails?.firstName}{" "}
                        {admin.userDetails?.lastName}
                      </p>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete this administrator account. This
