      ...
      if (response.success) {
        toast.success("Transaction Complete", {
          description: buyProduct
            ? `Bought ${buyProduct.name}`
            : `Bought ${cartCount} items`,
        });
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground font-medium text-lg">
            Buy verified educational items and tools.
          </p>
        </div>
        <div className="flex items-center gap-3">
          <Link href="/products">
            <Button
              variant="outline"
              className="h-12 px-6 rounded-xl border-2 font-black uppercase tracking-widest text-[10px]"
            >
          ...
          <Button
            className="h-12 px-6 rounded-xl bg-secondary hover:bg-muted border border-border relative"
      ...
      <AlertDialog open={showBuyConfirm} onOpenChange={setShowBuyConfirm}>
        <AlertDialogContent className="rounded-[2rem] border-border bg-card/95 backdrop-blur-2xl p-10 shadow-2xl">
          ...
          <AlertDialogFooter className="mt-10 gap-3 justify-center">
            <AlertDialogCancel className="h-14 px-8 rounded-2xl border-border bg-transparent text-muted-foreground font-black uppercase tracking-widest text-[10px] hover:bg-muted">
              Abort
            </AlertDialogCancel>
            <AlertDialogAction
              onClick={() => {
