            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <DrawerDescription className="font-medium text-[10px] uppercase tracking-widest text-muted-foreground">
                    {cartCount} unit{cartCount !== 1 ? "s" : ""} staged for
                    transfer
                  </DrawerDescription>
                </div>
              </div>
              ...
              <div className="space-y-3">
                {Object.entries(cart).map(([id, qty]) => {
                  ...
                  return (
                    <div
                      key={id}
                      className="flex items-center gap-4 p-4 rounded-3xl bg-card border border-border/60 shadow-sm group hover:border-primary/20 transition-all"
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="font-black text-foreground truncate text-sm tracking-tight">
                          {product.name}
                        </p>
                        <div className="flex items-center gap-1.5 mt-1">
                          <img src="/bcoin.svg" className="h-4 w-4" alt="" />
                          <span className="font-black text-primary tabular-nums text-xs">
                            {product.price}
                          </span>
                        </div>
                      </div>
