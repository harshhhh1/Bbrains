    ...
    <Card className="group relative flex flex-col overflow-hidden rounded-[2.5rem] border-border/60 bg-card/50 backdrop-blur-sm hover:border-primary/40 hover:shadow-2xl hover:shadow-primary/5 transition-all duration-500 h-full">
      ...
      >
        ...
        <div className="absolute top-4 left-4 flex flex-col gap-2">
          <Badge
            ...
            className="text-[9px] font-black uppercase tracking-widest px-2.5 py-1 backdrop-blur-md bg-background/80 shadow-sm border-none"
          >
      ...
      <CardContent className="flex-1 p-6 space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground line-clamp-2 font-medium leading-relaxed opacity-80">
            {product.description ||
              "Verified school item provided for academic excellence."}
          </p>
        </div>
      ...
      <CardFooter className="p-6 pt-0 flex flex-col gap-3">
        {!isOutOfStock ? (
          <div className="flex items-center gap-3 w-full">
            {inCart > 0 ? (
              <div className="flex items-center bg-muted/50 rounded-2xl border border-border/40 p-1 flex-1 h-12">
                ...
                <span className="flex-1 text-center text-lg font-black text-foreground tabular-nums">
                  {inCart}
                </span>
                <Button
                  variant="ghost"
          ...
          <Button
            disabled
            className="w-full h-12 rounded-2xl bg-muted/50 text-muted-foreground font-black uppercase tracking-widest text-[10px] border border-border/40 cursor-not-allowed"
          >
