...
import { usePersonalTransactions } from "@/features/transactions/model/usePersonalTransactions";
import {
  getViewCopy,
  formatCurrency,
} from "@/features/transactions/model/utils";
import { DuesCard } from "@/features/transactions/ui/DuesCard";
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card className="border-border/60 shadow-sm overflow-hidden bg-brand-orange/5 border-l-4 border-l-brand-orange">
          <CardContent className="p-5">
            <p className="text-xs font-black uppercase tracking-[0.16em] text-brand-orange/70">
              Transactions
            </p>
            ...
            <p className="mt-1 text-xs font-medium text-muted-foreground">
              Only your own{" "}
              {activeView === "fees" ? "fee payments" : "salary receipts"} are
              shown here.
            </p>
          </CardContent>
        </Card>
        <Card className="border-border/60 shadow-sm overflow-hidden bg-brand-purple/5 border-l-4 border-l-brand-purple">
          <CardContent className="p-5">
            <p className="text-xs font-black uppercase tracking-[0.16em] text-brand-purple/70">
              Total Amount
            </p>
            <p className="mt-2 text-3xl font-black text-foreground">
