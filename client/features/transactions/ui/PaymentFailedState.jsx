...
export function PaymentFailedState({ error, onRetry }) {
  return (
    <div className="flex flex-col items-center justify-center py-12 px-6 text-center space-y-8 bg-red-500/5 rounded-[2.5rem] border-2 border-dashed border-red-500/20">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground font-medium max-w-sm">
          {error ||
            "We couldn't process your payment at this time. Please check your bank account or try a different payment method."}
        </p>
      </div>
