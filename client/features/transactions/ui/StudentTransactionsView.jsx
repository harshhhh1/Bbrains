...
import { useStudentTransactions } from "@/features/transactions/model/useStudentTransactions";
import { FeeSummaryCard } from "@/features/transactions/ui/FeeSummaryCard";
import { PaymentSuccessState } from "@/features/transactions/ui/PaymentSuccessState";
import { PaymentFailedState } from "@/features/transactions/ui/PaymentFailedState";
import { FeePaymentForm } from "@/features/transactions/ui/FeePaymentForm";
import { TransactionHistoryList } from "@/features/transactions/ui/TransactionHistoryList";
  ...
  return (
    <div className="space-y-10 pb-10 w-full max-w-full overflow-x-hidden">
      ...
      <SectionHeader
        ...
        subtitle="Manage your academic tuition fees and view payment history."
      />
      ...
      <TransactionHistoryList transactions={transactions} student={student} />
    </div>
  );
}
