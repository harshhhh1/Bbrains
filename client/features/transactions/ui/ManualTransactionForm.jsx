...
import { FormInput } from "@/features/admin/ui/form/FormInput";
import { FormSelect } from "@/features/admin/ui/form/FormSelect";
  ...
  return (
    <div className="space-y-4">
      <FormSelect
        ...
        value={form.category || ""}
        onChange={(value) => onChange({ category: value, targetUserId: "" })}
        options={[
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <FormInput
          label={
            referenceLabelByMode[form.paymentMode || ""] || "Reference / proof"
          }
