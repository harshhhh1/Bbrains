    ...
    <div className={cn("flex flex-col gap-6 rotate-1", className)} {...props}>
      <HandCard decoration="tack">
        <HandCardHeader>
          ...
          <HandCardDescription>Initialize a new verified agent account.</HandCardDescription>
        </HandCardHeader>
        <HandCardContent>
          <form onSubmit={handleSignUp}>
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-2">
                <HandLabel htmlFor="repeat-password">Confirm Credentials</HandLabel>
                <div className="relative">
                  <HandInput
                    id="repeat-password"
                    ...
                    disabled={isLoading}
                    className={errors.repeatPassword ? "border-hand-red pr-10" : "pr-10"}
                  />
                  <button
                    type="button"
                ...
                {errors.repeatPassword && (
                  <p className="text-sm text-hand-red font-patrick">{errors.repeatPassword}</p>
                )}
              </div>
              ...
              <HandButton type="submit" className="w-full mt-2 rotate-1" disabled={isLoading}>
            ...
            <div className="mt-8 text-center text-lg font-patrick text-hand-pencil/80">
              ...
              <Link href="/auth/login" className="text-hand-pencil underline underline-offset-4 decoration-2 decoration-wavy hover:text-hand-blue">
                Login Here
              </Link>
            </div>
          </form>
