...
export function EventCalender({ events = [] }) {
      ...
      <div className="flex flex-col gap-4 max-h-[400px] overflow-y-auto custom-scrollbar pr-2">
        {events.length > 0 ? (
          events.map((event) => (
            <div
              key={event.id}
              className="border border-gray-100 dark:border-gray-800 rounded-md p-3 border-t-4 odd:border-t-blue-200 even:border-t-purple-300 bg-gray-50/50 dark:bg-gray-800/30"
            >
