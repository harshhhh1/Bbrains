    ...
    <div className="flex h-full flex-col">
      {isSystemLocked && (
        <div className="m-5 rounded-xl bg-amber-500/10 p-3 text-sm text-amber-600 border border-amber-500/20">
          This is a system role. Its name and color are protected, but you can
          still manage its permissions and members.
        </div>
      )}
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">
                    Once you delete this role, it cannot be recovered. Users
                    with this role will lose it.
                  </p>
                  {!showDeleteConfirm ? (
                    <button
                    ...
                    <div className="mt-4 space-y-3">
                      <div className="rounded-lg bg-background p-3 text-xs text-foreground border border-border/60">
                        ...
                        <strong>{role.name}</strong>? This action is permanent.
                      </div>
