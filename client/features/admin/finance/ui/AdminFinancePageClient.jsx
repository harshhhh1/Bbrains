    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card className="border-border/60 shadow-sm">
          <CardContent className="p-5">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Outstanding amount after subtracting received income from
              class-based accrual
            </p>
          </CardContent>
        </Card>
      ...
      <Card className="border-border/60 shadow-sm">
        <CardHeader>
          ...
          <CardDescription>
            Latest successful entries associated with the current finance
            snapshot.
          </CardDescription>
        </CardHeader>
        ...
        <Card className="border-dashed border-border/70 shadow-sm transition-all hover:border-primary/40 hover:shadow-md">
          <CardContent className="flex items-start justify-between gap-4 p-5">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Update fee-related config values if you want accrued income and
                configured totals to stay current.
              </p>
            </div>
