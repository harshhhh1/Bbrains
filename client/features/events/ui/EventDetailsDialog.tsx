        ...
        <div className="p-8 space-y-8 bg-card">
          <div className="grid grid-cols-2 gap-6">
            <div className="flex items-start gap-4 p-4 rounded-2xl bg-muted/30 border border-border/50">
              ...
              <div>
                <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground mb-1">Time Frame</p>
            ...
            <div className="flex items-start gap-4 p-4 rounded-2xl bg-muted/30 border border-border/50">
              ...
              <div className="min-w-0">
                ...
                <p className="text-sm font-bold truncate">{event.location || "Main Campus"}</p>
              </div>
            </div>
          </div>

          <div className="space-y-4">
            <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-primary">About the Event</h4>
            <DialogDescription className="text-base text-foreground/80 leading-relaxed whitespace-pre-wrap">
              {event.description || "Join us for this institution-wide event. Stay tuned for more details and announcements regarding the schedule and speakers."}
            </DialogDescription>
          </div>
          ...
          <div className="pt-6 border-t border-border flex items-center justify-between">
            <div className="flex items-center gap-2">
               ...
               <span className="text-xs font-bold text-muted-foreground">Hosted by Bbrains Institution</span>
            </div>
            <Button variant="outline" size="sm" className="rounded-xl font-bold gap-2" onClick={handleShare}>
