...
import type { StudyMaterialFolder } from '../types/study-materials.types'
...
export function FolderCard({ folder, isSelected, onSelect, onNavigate, onRename, onDelete }: FolderCardProps) {
