            ...
            <DrawerHeader className="border-b border-border/60 p-6 text-left">
              <div className="flex items-start justify-between gap-4">
                <div className="space-y-2">
                  ...
                  <DrawerDescription>
                    Define the standard, subject list, fee model, duration,
                    class size, and a timetable for this class.
                  </DrawerDescription>
                </div>
                <DrawerClose asChild>
            ...
            <div className="flex-1 space-y-4 overflow-y-auto p-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      setForm((current) => ({
                        ...current,
                        studentCapacity: event.target.value,
                      }))
                    }
                    placeholder="40"
                  />
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground italic">
                  Note: For detailed exams and results, use the Semester section
                  below.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between border-b border-border/60 pb-2">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-muted-foreground text-balance">
                      Define structured semesters with specific subject codes
                      and total marks.
                    </p>
                  </div>
                  <Button
                ...
                <div className="grid gap-6">
                  {form.semesters.map((semester) => (
                    <div
                      key={semester.id}
                      className="relative space-y-4 rounded-2xl border border-border/60 bg-muted/5 p-5 transition-colors hover:bg-muted/10"
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-2">
                          <Button
                            ...
                            variant="ghost"
                            size="sm"
                            onClick={() => addSubjectToSemester(semester.id)}
                  ...
                  <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                    <div>
                      ...
                      <p className="mt-1 text-xs text-muted-foreground">
                        Open the timetable popup to plan daily lectures, edit
                        them later, and assign them to this class.
                      </p>
                    </div>
                    <Button
                      type="button"
                      variant="outline"
                      onClick={() => onTimetableDialogOpenChange(true)}
                    >
                      <CalendarDays className="mr-2 size-4" />
                      {form.timetable.length
                        ? "Edit Timetable"
                        : "Create Timetable"}
                    </Button>
                  </div>
