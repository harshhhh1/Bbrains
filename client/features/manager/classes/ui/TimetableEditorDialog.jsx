...
const createEmptyEntry = (day = "Monday", subject = "") => ({
  day,
  subject,
  startTime: "09:00",
  endTime: "10:00",
...
export function TimetableEditorDialog({
  ...
  function handleSave() {
    ...
    const invalidTiming = trimmedEntries.find(
          ...
          <DrawerHeader className="border-b border-border/60 p-6 text-left">
            <div className="flex items-start justify-between gap-4">
              <div className="space-y-2">
                ...
                <DrawerDescription>
                  Build the daily lecture plan for this class. Subject
                  suggestions come from the class subjects.
                </DrawerDescription>
              </div>
              <DrawerClose asChild>
          ...
          <div className="flex-1 space-y-6 overflow-y-auto p-6">
            {subjectSuggestions.length === 0 ? (
              <div className="rounded-xl border border-dashed border-border/70 bg-muted/20 p-4 text-sm text-muted-foreground">
                Add subjects in the class form first if you want quick subject
            ...
            <div className="grid gap-6">
              {entriesByDay.map(({ day, entries }) => (
                <Card
                  key={day}
                  className="border-border/60 shadow-none bg-muted/5"
                >
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
                    ...
                    <div className="flex items-center gap-2">
                      <Button
                        ...
                        className="border-orange-200 bg-orange-50/30 text-orange-700 hover:bg-orange-50"
                      >
                        ...
                        >
                          ...
                          <div className="space-y-2">
                            ...
                            <Input
                              value={entry.room || ""}
                              onChange={(event) =>
                                updateEntry(index, "room", event.target.value)
                              }
