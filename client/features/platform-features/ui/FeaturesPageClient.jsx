    ...
    <div className="min-h-screen bg-hand-paper bg-paper-texture bg-size-[24px_24px] text-hand-pencil overflow-x-hidden selection-bg-hand-yellow selection-text-hand-pencil">
      ...
      <nav className="border-b-[3px] border-hand-pencil border-dashed bg-white/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 group">
            <Brain
              className="w-8 h-8 text-hand-red group-hover:-rotate-12 transition-transform"
              strokeWidth={2.5}
            />
            <span className="font-kalam text-3xl font-bold tracking-tight">
              bBrains
            </span>
          </Link>
      ...
      <section className="pt-24 pb-16 px-6 max-w-5xl mx-auto text-center relative">
        <h1 className="font-kalam text-5xl md:text-7xl font-bold leading-[1.1] text-hand-pencil mb-6">
          Platform{" "}
          <span className="relative inline-block px-2 group cursor-default">
        ...
        <p className="font-patrick text-xl md:text-2xl text-hand-pencil/80 max-w-2xl mx-auto leading-relaxed">
          Discover how our gamified Learning Management System turns routine
          academic tasks into engaging, rewarding experiences for every student
          on campus.
        </p>
      </section>
      ...
      <section className="py-16 px-6 max-w-5xl mx-auto space-y-24">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1 relative">
            <HandCard
              decoration="tack"
              variant="yellow"
              className="rotate-2 z-10 w-full max-w-md mx-auto"
            >
              <HandCardHeader>
                <div className="flex items-center gap-3">
                  <Star
                    className="w-8 h-8 text-hand-yellow"
                    fill="currentColor"
                  />
              ...
              <HandCardContent className="space-y-4 font-patrick text-lg">
                <div className="flex items-start gap-3">
                  ...
                  <p>
                    Earn XP for attending classes, completing assignments, and
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-hand-blue shrink-0 mt-0.5" />
                  <p>
                    Unlock achievements and badges to show off academic prowess.
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-hand-blue shrink-0 mt-0.5" />
          ...
          <div className="order-1 md:order-2 space-y-6">
            ...
            <p className="font-patrick text-xl text-hand-pencil/80">
              Transform the grind of studying into an exciting journey. Our XP
              system integrates seamlessly with course syllabi, providing
              instant gratification and long-term motivation for your students.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="font-patrick text-xl text-hand-pencil/80">
              Students earn virtual currency through academic excellence and
              community participation. The built-in digital wallet keeps track
              of their balance, transaction history, and pending rewards.
            </p>
          </div>
          <div className="relative">
            <HandCard
              decoration="tape"
              className="bg-white -rotate-2 z-10 w-full max-w-md mx-auto"
            >
              <HandCardHeader>
                <div className="flex items-center gap-3">
              ...
              <HandCardContent className="space-y-4 font-patrick text-lg">
                <div className="flex items-center justify-between p-3 border-2 border-hand-pencil border-dashed rounded-wobbly">
                  ...
                  <span className="font-kalam text-2xl font-bold text-hand-red">
                    1,250 🪙
                  </span>
                </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1 relative">
            <HandCard
              decoration="tack"
              variant="blue"
              className="rotate-1 z-10 w-full max-w-md mx-auto"
            >
              <HandCardHeader>
                <div className="flex items-center gap-3">
                  <Store className="w-8 h-8 text-white" />
                  <HandCardTitle className="text-3xl">
                    <span className="bg-hand-yellow text-hand-pencil px-2 -rotate-1 inline-block">
                      Rewards Store
                    </span>
                  </HandCardTitle>
                </div>
          ...
          <div className="order-1 md:order-2 space-y-6">
            ...
            <p className="font-patrick text-xl text-hand-pencil/80">
              Bridge the gap between digital achievements and real-world value.
              Configure a custom marketplace where students can spend their
              hard-earned wallet balance on tangible campus rewards.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="font-patrick text-xl text-hand-pencil/80">
              Provide faculty with powerful tools to monitor student engagement.
              Track which gamification strategies work best and identify
              students who might need an extra push.
            </p>
          </div>
          <div className="relative">
            <HandCard
            ...
            >
              ...
              <HandCardContent className="space-y-4 font-patrick text-lg text-white">
                ...
                <p className="text-center font-kalam font-bold mt-2">
                  Class Average: +15%
                </p>
              </HandCardContent>
            </HandCard>
      ...
      <section className="py-24 px-6 text-center max-w-3xl mx-auto">
        <h2 className="font-kalam text-4xl font-bold mb-8">
      ...
      <footer className="py-12 px-6 max-w-5xl mx-auto text-center border-t-[3px] border-hand-pencil border-dashed mt-12 bg-white/50">
        <div className="flex items-center justify-center gap-2 text-hand-pencil/60 font-patrick text-lg">
          <span>
            Built with <span className="text-hand-red">♥</span> to learn better.
          </span>
