...
import { suggestionApi } from "@/services/api/client";
    ...
    <div className="max-w-5xl mx-auto space-y-8">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">
          Help us improve BBrains by sharing your ideas and reporting issues.
        </p>
      </div>
          ...
          <form onSubmit={handleSubmit}>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <label className="pb-3 text-[10px] font-black uppercase tracking-widest text-muted-foreground ml-1">
                  Details
                </label>
                <Textarea
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 text-muted-foreground bg-muted/20 rounded-3xl border border-dashed px-6 text-center">
              ...
              <p className="text-sm mt-1">
                Be the first to share an idea to improve the platform!
              </p>
            </div>
          ) : (
            <div className="space-y-4">
              {suggestions.map((s) => (
                <Card
                  key={s.id}
                  className="overflow-hidden border-none shadow-sm bg-card/50 hover:bg-card transition-colors group"
                >
                      ...
                      <div className="flex-1 space-y-1">
                        <div className="flex items-center gap-3">
                          ...
                          <Badge
                            variant="outline"
                            className={cn(
                              "text-[10px] uppercase font-black px-2 py-0 h-5",
                        ...
                        <p className="text-[10px] text-muted-foreground pt-1">
                          Submitted on {format(new Date(s.createdAt), "PPP")}
                        </p>
                      </div>
