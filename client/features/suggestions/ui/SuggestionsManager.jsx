...
const statusConfig = {
  ...
  reviewed: {
    icon: <Search className="size-3 mr-1" />,
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <Badge
                    variant="outline"
                    className={cn(
                      "text-[10px] uppercase font-black shrink-0 ml-2",
                ...
                <div className="flex items-center justify-between mt-auto pt-2 border-t border-border/50">
                  <div className="flex flex-col">
                    <span className="text-xs font-medium text-foreground">
                      {row.user?.userDetails?.firstName}{" "}
                      {row.user?.userDetails?.lastName}
                    </span>
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="space-y-2">
                  ...
                  <DrawerDescription className="text-muted-foreground text-xs">
                    Submitted by {selected?.user?.username} on{" "}
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <Button
                    ...
                    onClick={() =>
                      selected && handleUpdateStatus(selected.id, "pending")
                    }
                  >
                    Pending
                  </Button>
                  <Button
                    ...
                    onClick={() =>
                      selected && handleUpdateStatus(selected.id, "reviewed")
                    }
                  >
                    Reviewed
                  </Button>
                  <Button
                    ...
                    onClick={() =>
                      selected && handleUpdateStatus(selected.id, "implemented")
                    }
                  >
                    Done
                  </Button>
                  <Button
                    ...
                    onClick={() =>
                      selected && handleUpdateStatus(selected.id, "rejected")
                    }
                  >
                    Reject
                  </Button>
