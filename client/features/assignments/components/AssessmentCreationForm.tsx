...
interface AssessmentCreationFormProps {
  ...
  onChange: (updates: Partial<AssessmentCreationFormProps["form"]>) => void;
    ...
    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
      <div className="space-y-2">
        ...
        <Select
          ...
          onValueChange={(value) => onChange({ assessmentType: value as "test" | "exam" })}
        >
      ...
      <div className="space-y-2">
        <label className="text-xs font-black uppercase tracking-widest text-muted-foreground ml-1">Max Score</label>
        <Input
          type="number"
          min="1"
          step="0.01"
