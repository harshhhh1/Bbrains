...
export function GradingTable({ students, rows, maxMarks, onRowChange }) {
  return (
    <div className="overflow-x-auto rounded-2xl border border-border/60 bg-background">
      <Table className="table-fixed">
        <TableHeader className="bg-muted/30">
          <TableRow>
            <TableHead className="w-[260px] font-black uppercase tracking-widest text-[10px]">
              Candidate
            </TableHead>
            <TableHead className="w-[160px] font-black uppercase tracking-widest text-[10px]">
              Score
            </TableHead>
            <TableHead className="min-w-[320px] font-black uppercase tracking-widest text-[10px]">
              Registry Notes
            </TableHead>
          </TableRow>
        </TableHeader>
              ...
              >
                ...
                <TableCell>
                  <Input
                    ...
                    onChange={(e) =>
                      onRowChange(student.id, "marksObtained", e.target.value)
                    }
                    placeholder="0"
                ...
                <TableCell className="align-top whitespace-normal">
                  <Textarea
                    value={row.remark}
                    onChange={(e) =>
                      onRowChange(student.id, "remark", e.target.value)
                    }
