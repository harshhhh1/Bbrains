...
export function AssignmentsTabs({ activeTab, onTabChange, counts }) {
  const tabs = [
    { id: "all", label: "All" },
          ...
          return (
            ...
            >
              ...
              {tab.count !== undefined && tab.count > 0 && (
                <span
                  className={`text-xs px-2 py-0.5 rounded-full ${isActive ? "bg-black dark:bg-white text-white dark:text-black" : "bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100"}`}
                >
                  {tab.count}
                </span>
              )}
