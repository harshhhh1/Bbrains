...
export function AssignmentViewDialog({ assignment, onClose }) {
                  ...
                  {assignment ? (
                    <>
                      ...
                      <Badge variant="outline">
                        {assignment.rewardPoints ?? 0} point
                        {(assignment.rewardPoints ?? 0) === 1 ? "" : "s"}
                      </Badge>
                    </>
                  ) : null}
                </div>
                    ...
                    <div className="flex items-center justify-between rounded-xl bg-muted/50 p-3 border border-border/40">
                      <div className="flex min-w-0 items-center gap-3">
                        ...
                        <span className="truncate text-sm font-bold text-foreground">
                          {assignmentFileUrl.split("/").pop()?.split("?")[0] ||
                            "Assignment file"}
                        </span>
                      </div>
                      <a
                ...
                <div className="space-y-3 pt-4 border-t border-border/40">
                  ...
                  <div className="space-y-4 rounded-2xl bg-muted/30 p-4 border border-border/50 shadow-inner">
                    ...
                    {assignment.submission.content ? (
                      <p className="text-sm text-foreground/80 bg-background/50 p-3 rounded-xl">
                        {assignment.submission.content}
                      </p>
                    ) : null}
                    ...
                    {assignment.submission.reviewRemark ? (
                      <div className="rounded-xl border-2 border-brand-orange/20 bg-brand-orange/5 px-4 py-3 shadow-sm animate-in fade-in slide-in-from-bottom-2">
                        <p className="mb-1 text-xs font-black uppercase tracking-widest text-brand-orange">
                          Teacher Verdict
                        </p>
