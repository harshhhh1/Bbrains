...
export function ProductsCreator() {
  ...
  const handleUpdateProduct = async () => {
    ...
    try {
      ...
      const isPending =
        selectedProduct.approval === "pending" ||
        selectedProduct.approval === "draft";
  ...
  const removeImage = (index) => {
    setForm((prev) => {
      ...
      return {
        ...
        imageUrl:
          prev.imageUrl === prev.images[index]
            ? newImages[0] || ""
            : prev.imageUrl,
      };
    });
      ...
      {loading ? (
        ...
        <Card className="border-2 border-dashed border-border/50 bg-muted/20 rounded-[2rem] py-24">
          <div className="flex flex-col items-center justify-center text-center px-6">
            ...
            <Button
              ...
              className="rounded-xl border-2 font-bold px-8"
            >
              Create Product
            </Button>
          </div>
        ...
        <div className="space-y-3">
          {products.map((product) => (
            <Card
              key={product.id}
              className="rounded-xl border-white/5 bg-white/[0.02] hover:border-white/10 transition-all"
            >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <Badge
                        className={cn(
                          "text-[10px] font-black uppercase tracking-widest px-2 py-0.5 border shrink-0",
                          statusColor(product.approval),
                        )}
                      >
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <Button
                      ...
                      className="h-8 w-8 rounded-lg hover:bg-brand-orange/10 hover:text-brand-orange"
                    >
            ...
            <div className="grid h-[100dvh] max-h-[100dvh] grid-cols-1 overflow-hidden xl:grid-cols-[320px_minmax(0,1fr)]">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <TabsList className="grid h-[56px] w-full grid-cols-2 items-stretch gap-2 rounded-2xl border-white/10 bg-white/5 p-1">
                        <TabsTrigger
                          value="physical"
                          className="h-full flex items-center justify-center rounded-xl font-bold data-[state=active]:bg-white/10 data-[state=active]:text-white data-[state=active]:shadow-none transition-all px-4"
                        >
                          Physical
                        </TabsTrigger>
                        <TabsTrigger
              ...
              <div className="flex min-h-0 flex-col overflow-y-auto p-6 sm:p-8">
                <div className="mx-auto w-full max-w-2xl space-y-8">
                  ...
                  <div className="space-y-4">
                    <p className="text-[10px] font-black uppercase tracking-[0.28em] text-white/35 px-1">
                      Product Images
                    </p>
                      ...
                      {form.images.map((url, index) => (
                        ...
                        >
                          ...
                          <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center gap-2 p-2">
                              ...
                              <Button
                                ...
                                className={cn(
                                  ...
                                  form.imageUrl === url
                                    ...
                                    : "bg-white/10 text-white hover:bg-brand-orange",
                                )}
                                title="Set as Main"
                              >
                            ...
                            {form.imageUrl === url && (
                              <Badge className="bg-brand-orange text-[8px] font-black uppercase tracking-widest px-1.5 py-0">
                                Main
                              </Badge>
                            )}
                          </div>
                  ...
                  <div className="space-y-5">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className="h-[52px] rounded-2xl bg-white/[0.03] border-white/10"
                      />
                    </div>
                    <Textarea
                      ...
                      className="min-h-[150px] rounded-2xl bg-white/[0.03] border-white/10"
                    />
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <Input
                        ...
                        placeholder="Stock"
                        className="h-[52px] rounded-2xl bg-white/[0.03] border-white/10"
                        disabled={form.productType === "digital"}
                      />
                    </div>
                    ...
                    <Button
                      ...
                      className="w-full h-12 bg-brand-orange font-bold rounded-xl mt-4"
                    >
                      {isSubmitting ? (
      ...
      <AlertDialog open={showDeleteAlert} onOpenChange={setShowDeleteAlert}>
        <AlertDialogContent className="rounded-3xl border-white/10 bg-slate-950/95 backdrop-blur-2xl p-8 shadow-2xl">
          ...
          <AlertDialogFooter className="mt-6 gap-3">
            <AlertDialogCancel className="h-12 rounded-xl border-white/10 bg-transparent text-white/40 font-bold hover:bg-white/5">
              Cancel
            </AlertDialogCancel>
            <AlertDialogAction
              onClick={() =>
              ...
              className="h-12 rounded-xl bg-red-500 hover:bg-red-600 text-white font-black px-8"
            >
              {deletingId ? (
