  ...
  const fetchProduct = useCallback(async () => {
    try {
      ...
      if (resp.success && resp.data) {
        ...
        if (data.metadata?.previewImages)
          imgs.push(...data.metadata.previewImages);
      ...
      <div className="space-y-8 animate-in fade-in duration-500">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                <Badge
                  variant={
                    product.productType === "digital" ? "default" : "secondary"
                  }
          ...
          <Button
            ...
            className="h-10 px-4 rounded-xl border-red-500/20 text-red-400 hover:bg-red-500/10 hover:border-red-500/40"
          >
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card className="rounded-2xl border-white/5 bg-white/[0.02]">
              <CardContent className="p-6">
                <h3 className="text-sm font-black uppercase tracking-widest text-white/30 mb-4">
                  Product Images
                </h3>
                  ...
                  {images.map((img, idx) => (
                    <div
                      ...
                      className={cn(
                        ...
                        dragIndex === idx
                          ? "border-brand-orange opacity-50"
                          : "border-white/10",
                    ...
                    >
                      ...
                      {idx === 0 && (
                        <Badge className="absolute top-2 right-2 text-[9px] font-black uppercase bg-brand-orange text-white px-1.5 py-0">
                          Primary
                        </Badge>
                      )}
                    </div>
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-lg font-black text-brand-orange">
                      {(
                        (product.unitsSold || 0) * Number(product.price)
                      ).toFixed(0)}{" "}
                      B-Coins
                    </span>
                  </div>
