      ...
      <div className="space-y-8 animate-in fade-in duration-500">
        <div className="flex items-center justify-between">
          ...
          <Link href="/products">
            <Button
              variant="outline"
              className="h-10 px-4 rounded-xl border-2 font-bold text-xs hover:bg-white/5"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="rounded-2xl border-white/5 bg-white/[0.02]">
            <CardContent className="p-6">
              ...
              <p className="text-3xl font-black text-white">
                {sales.totalEarnings}{" "}
                <span className="text-sm text-brand-orange font-bold">
                  B-Coins
                </span>
              </p>
            </CardContent>
          ...
          <Card className="rounded-2xl border-white/5 bg-white/[0.02]">
            <CardContent className="p-6">
              ...
              <p className="text-2xl font-black text-white">
                {sales.digitalSales.units}{" "}
                <span className="text-sm text-white/30 font-bold">units</span>
              </p>
              <p className="text-sm text-blue-400 font-bold mt-1">
                {sales.digitalSales.revenue} B-Coins
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="rounded-2xl border-white/5 bg-white/[0.02]">
            <CardContent className="p-6">
              ...
              <p className="text-2xl font-black text-white">
                {sales.physicalSales.units}{" "}
                <span className="text-sm text-white/30 font-bold">units</span>
              </p>
              <p className="text-sm text-green-400 font-bold mt-1">
                {sales.physicalSales.revenue} B-Coins
              </p>
            </CardContent>
          </Card>
