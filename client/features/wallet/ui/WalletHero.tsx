        ...
        <div>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-2xl border border-border bg-card/50 p-5 shadow-sm flex flex-col justify-between backdrop-blur-sm transition-transform hover:scale-[1.02]">
              <div>
                <p className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground">XP Collected</p>
                <p className="mt-3 text-3xl font-semibold text-foreground">{formatPoints(xp)}</p>
              </div>
              <p className="mt-2 text-[11px] text-muted-foreground/70">Academic growth across tasks and milestones.</p>
            </div>
            <div className="rounded-2xl border border-border bg-card/50 p-5 shadow-sm flex flex-col justify-between backdrop-blur-sm transition-transform hover:scale-[1.02]">
              <div>
                <p className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground">Current Level</p>
        ...
        <div className="rounded-[28px] border border-border bg-card/30 p-5 shadow-sm backdrop-blur-md">
          ...
          <div className="mt-6 grid gap-3">
            <div className="rounded-2xl bg-muted/30 p-4 border border-border/50">
              <p className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground">Earn</p>
              <p className="mt-2 text-xs font-medium text-foreground/80">Assignments, attendance, quiz performance, and streak bonuses.</p>
            </div>
            <div className="rounded-2xl bg-muted/30 p-4 border border-border/50">
            ...
            <div className="flex gap-3 mt-1">
              ...
              <Link href="/assignments" className="flex-1 rounded-full border border-border bg-background/50 px-4 py-3 text-center text-sm font-semibold text-foreground transition hover:bg-muted active:scale-95">
                Earn More
              </Link>
            </div>
          </div>
