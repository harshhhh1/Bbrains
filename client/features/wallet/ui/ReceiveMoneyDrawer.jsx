...
import { QrCode as QrIcon, Share2, Copy } from "lucide-react";
import QRCode from "react-qr-code";
import { toast } from "sonner";

export function ReceiveMoneyDrawer({ open, onOpenChange, wallet }) {
        ...
        <div className="flex flex-col overflow-hidden">
          <DrawerHeader className="border-b border-border/60 p-8 text-center items-center">
            ...
            <DrawerDescription className="text-base font-medium max-w-xs mx-auto">
              Present this token to another agent to initialize an incoming
              transfer.
            </DrawerDescription>
          </DrawerHeader>
