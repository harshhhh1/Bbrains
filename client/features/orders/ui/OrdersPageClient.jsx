    ...
    <DashboardContent className="mx-auto w-full max-w-5xl p-6 md:p-12 space-y-10">
      <header>
        ...
        <p className="text-muted-foreground text-lg font-medium mt-2">
          Monitor order status and pickup codes.
        </p>
      </header>
      ...
      {orders.length === 0 ? (
        <Card className="border-2 border-dashed border-border/40 bg-muted/10 rounded-[2.5rem] py-32">
          <div className="flex flex-col items-center justify-center text-center px-6">
            ...
            <p className="text-muted-foreground mt-2 max-w-xs font-medium mb-8">
              Initiate your first purchase at the campus marketplace.
            </p>
            <Link href="/market">
              <Button
                size="lg"
                className="rounded-2xl font-black uppercase tracking-widest text-xs px-10 shadow-lg shadow-primary/20"
              >
                Access Market
              </Button>
            </Link>
        ...
        <Tabs defaultValue="all" className="space-y-8">
          <TabsList className="bg-muted/40 border border-border/40 rounded-2xl p-1.5 h-auto">
            <TabsTrigger
              value="all"
              className="rounded-xl px-6 py-2.5 font-bold data-[state=active]:bg-card data-[state=active]:text-primary data-[state=active]:shadow-sm"
            >
