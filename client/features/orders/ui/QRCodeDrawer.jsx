...
export function QRCodeDrawer({ order, isOpen, onClose }) {
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="space-y-2">
                ...
                <DrawerDescription className="text-sm font-medium text-muted-foreground">
                  Present this code to the staff to confirm delivery.
                </DrawerDescription>
              </div>
              <DrawerClose asChild>
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-6 space-y-8">
            ...
            <div className="text-center space-y-2">
              <p className="text-xs font-black uppercase tracking-widest text-primary">
                Order Number {order.id.toString().slice(-6).toUpperCase()}
              </p>
              <p className="text-[10px] text-muted-foreground font-bold max-w-[220px] leading-relaxed">
                System scan required for digital receipt generation.
              </p>
            </div>
          </div>
