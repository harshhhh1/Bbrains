...
import { Users, X, Loader2, Calendar } from "lucide-react";
...
export function AcknowledgeDrawer({ open, onOpenChange, users, loading }) {
  return (
            ...
            {loading ? (
              ...
              <div className="space-y-3">
                {users.map((ack) => (
                  <div
                    key={ack.userId}
                    className="flex items-center justify-between p-4 rounded-2xl border border-border/50 bg-card/50"
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="space-y-0.5">
                        <p className="text-sm font-bold">
                          {ack.userDetails?.firstName}{" "}
                          {ack.userDetails?.lastName}
                        </p>
