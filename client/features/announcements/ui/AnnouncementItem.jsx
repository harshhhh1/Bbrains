...
import { Trash2, ThumbsUp, Share2, Loader2, Users } from "lucide-react";
...
export function AnnouncementItem({
  ...
  const hasAcknowledged = announcement.acknowledgedBy?.some(
          ...
          <div className="space-y-0.5">
            <div className="flex items-center gap-2">
              <h4 className="font-bold text-sm">
                {announcement.user?.userDetails?.firstName}{" "}
                {announcement.user?.userDetails?.lastName}
              </h4>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            {acknowledging ? (
              ...
              <ThumbsUp
                className={`h-3.5 w-3.5 ${hasAcknowledged ? "fill-current" : ""}`}
              />
            )}
