...
export function SubmissionCard({
  ...
  if (!hasSubmitted) {
    statusBadge = (
      <Badge
        variant="outline"
        className="border-red-200 bg-red-50 text-red-600 dark:bg-red-950/30"
      >
    ...
    statusBadge = (
      <Badge
        variant="outline"
        className="border-orange-200 bg-orange-50 text-orange-600 dark:bg-orange-950/30"
      >
    ...
    <Card className="border-border/60">
      <CardContent className="flex flex-col gap-4 p-4 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="min-w-0 flex-1 space-y-2">
            <div className="flex flex-wrap items-center gap-2">
              ...
              {isLateSubmission && (
                <Badge
                  variant="outline"
                  className="border-amber-200 bg-amber-50 text-amber-600 dark:bg-amber-950/30"
                >
        ...
        <div className="flex shrink-0 items-center gap-2 sm:flex-col sm:items-end">
          ...
          <Button
            variant={
              submission?.reviewStatus === "completed" ? "outline" : "default"
            }
            size="sm"
            className={cn(
              "gap-1.5",
