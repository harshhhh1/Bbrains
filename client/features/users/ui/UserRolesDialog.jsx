...
export function UserRolesDialog({ open, onOpenChange, userId, username }) {
                ...
                {allRoles.map((role) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <div
                          className={`h-4 w-4 rounded-full bg-white transition-transform duration-200 flex items-center justify-center ${
