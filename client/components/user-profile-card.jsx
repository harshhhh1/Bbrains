        ...
        <div className="space-y-3 rounded-[8px] bg-[#1e1f22] p-3 shadow-sm">
          ...
          <div className="space-y-3">
            <div className="space-y-1.5">
              <h3 className="text-[12px] font-bold uppercase tracking-wider text-[#b5bac1]">
                Roles
              </h3>
                ...
                {roles && roles.length > 0 ? (
                  roles.map((role) => (
                    <span
                      ...
                      style={{
                        borderLeft: `2px solid ${role.color || "#5865f2"}`,
                      }}
                    >
                      <div
                  ...
                  <span className="rounded-[4px] bg-[#2b2d31] px-2 py-1 text-[11px] font-medium">
                    User
                  </span>
                )}
              </div>
            ...
            <div className="flex items-center gap-3">
              <div className="space-y-1">
                <h3 className="text-[10px] font-bold uppercase tracking-wider text-[#b5bac1]">
                  Level
                </h3>
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs font-bold text-[#5865f2]">
                  {user?.xp || 0} XP
                </p>
              </div>
            </div>
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm leading-snug text-[#dbdee1]">
              {user?.bio || (
                <span className="italic text-[#949ba4]">No bio yet...</span>
              )}
            </p>
          </div>
