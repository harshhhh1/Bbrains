...
export function UiModeToggle({
  ...
  return (
    <div
      className={cn(
        "rounded-[24px] border-2 border-dashed border-hand-pencil/20 bg-hand-paper p-4",
        className,
      )}
    >
      <p className="font-kalam text-3xl font-bold text-hand-pencil">{title}</p>
      <p className="mt-1 font-patrick text-lg text-hand-pencil/70">
        {description}
      </p>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-patrick text-base text-hand-pencil/65">
                    {item.note}
                  </p>
                </div>
              </div>
