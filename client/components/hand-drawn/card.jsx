...
const HandCard = React.forwardRef(
  (
    { className, decoration = "none", variant = "default", children, ...props },
    ref,
  ) => {
    return (
      <div
...
const HandCardHeader = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
...
const HandCardTitle = React.forwardRef(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "font-kalam text-2xl font-bold leading-none tracking-tight text-hand-pencil",
      className,
    )}
    {...props}
  />
...
const HandCardDescription = React.forwardRef(({ className, ...props }, ref) => (
  <p
    ref={ref}
...
const HandCardContent = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("p-6 pt-0 font-patrick text-lg", className)}
    {...props}
  />
));
HandCardContent.displayName = "HandCardContent";

const HandCardFooter = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
