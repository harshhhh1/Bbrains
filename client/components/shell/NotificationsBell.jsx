...
export function NotificationsBell() {
  ...
  const getIcon = (type) => {
    switch (type) {
      ...
      case "announcement":
        return <Megaphone className="h-4 w-4 text-brand-orange" />;
      case "chat":
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          {unreadCount > 0 && (
            <Badge className="absolute -top-1 -right-1 h-4 w-4 flex items-center justify-center p-0 bg-brand-orange text-[10px] border-2 border-background">
